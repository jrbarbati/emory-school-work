...
CODE WRITTEN BY OTHER STUDENTS. Joseph Barbati
*/

//Due by Friday, 2/5 at  11:59pm
...
public class GuessingGame {
    ...
    /**
     * creates an ArrayList with numbers 1000 - 9999
     */
	public GuessingGame() {
...
//        System.out.println("Size of List (updateMyGuess())" + sizeOfListCheck2);
        ...
        int secondDigit = ((guess / 10) / 10) % 10;
        int firstDigit = (((guess / 10) / 10) / 10) % 10;
...
//            System.out.println("Number of Guesses: " + countGuesses);
            ...
            int fourthDigitCheck = numberToRemove % 10;
            int thirdDigitCheck = (numberToRemove / 10) % 10;
            int secondDigitCheck = ((numberToRemove / 10) / 10) % 10;
            int firstDigitCheck = (((numberToRemove / 10) / 10) / 10) % 10;
...
//                    System.out.println("Removed: \t\t" + numberToRemove);
     ...
     */
    private int countMatches(int first, int second, int third, int fourth) {
        int fourthDigit = guess % 10;
        int thirdDigit = (guess / 10) % 10;
        int secondDigit = ((guess / 10) / 10) % 10;
        int firstDigit = (((guess / 10) / 10) / 10) % 10;
